...
export const COUNTRY_GUIDE_REGIONS: CountryGuideRegion[] = [
  ...
  },
  {
    ...
    countries: [
      ...
      entry("italya", "İtalya", "it", "İtalya", "Schengen ve ulusal D tipi süreçlere giriş.", "İtalya vize rehberi | Vize Firmaları", "İtalya turistik ve çalışma vizesi rehberi."),
      ...
      entry("malta", "Malta", "mt", "Malta", "Schengen ve yatırım temelli oturuma giriş.", "Malta vize rehberi | Vize Firmaları", "Malta Schengen ve oturum rehberi."),
