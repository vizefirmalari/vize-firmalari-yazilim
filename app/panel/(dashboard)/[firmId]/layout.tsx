...
export default async function FirmPanelSectionLayout({ children, params }: Props) {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-[#F4F6F8]">
      ...
      <div className="mx-auto flex min-h-0 w-full max-w-[1400px] flex-1 flex-col lg:min-h-0 lg:flex-row">
        ...
        <div className="flex min-h-0 min-w-0 flex-1 flex-col">
          <div className="flex h-full min-h-0 min-w-0 flex-1 flex-col px-4 py-6 sm:px-6 lg:px-8">
            {children}
          </div>
        </div>
      </div>
